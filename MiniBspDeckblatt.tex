...
=======
	...
	listof = entryprefix,				% Präfix in Tabellen und Abbildungsverzeichniss
	titlepage= on,				% own page for each title page
	captions= tableabove, %platzierung der Beschreibung
	%tocindent,
>>>>>>> 843c1ee70905e7b69234f5ad6f35cf8daaac6fd0
	ngerman
	%bibtotocnumbered
]
{scrbook}
...
%%Für die Färbung jedes 2ten Bibliographie eintrags
\usepackage{tikz}
...
\input{2_Konzept_Aufgabenstellung.tex}

\chapter{Fachliches Umfeld}
\label{sec:KapFachlichesUmfeld}
\input{3_Kap/3_Fachliches_Umfeld.tex}

\chapter{Anforderungsdefinition}
\label{sec:KapAnforderungsdefinition}
\input{4_Kap/4_Anforderungsdefinition_Pflichtenheft}

\chapter{Entwurf}
\label{sec:KapEntwurf}
\input{5_Kap/5_Entwurf.tex}

\chapter{Realisierung}
\label{sec:KapRealisierung}
\input{6_Kap/6_Realisierung}


\chapter{Inbetriebnahme}
\label{sec:KapInbetriebnahme}
\input{7_Kap/7_Inbetriebnahme}
...
\input{9_Zusammenfassung_und_Ausblick}
